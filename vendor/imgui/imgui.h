...
enum ImGuiPopupFlags_ { ImGuiPopupFlags_None                    = 0,
...
enum ImGuiTabItemFlags_ { ImGuiTabItemFlags_None                         = 0,
...
enum ImGuiTableRowFlags_ { ImGuiTableRowFlags_None    = 0,
...
enum ImGuiTableBgTarget_ { ImGuiTableBgTarget_None   = 0,
...
enum ImGuiFocusedFlags_ { ImGuiFocusedFlags_None                = 0,
...
enum ImGuiHoveredFlags_ { ImGuiHoveredFlags_None                    = 0,         // Return true if directly over the item/window, not obstructed by another window, not obstructed by an active popup or modal blocking inputs under them.
...
// A primary data type
enum ImGuiDataType_ { ImGuiDataType_S8,        // signed char / char (with sensible compilers)
...
// A sorting direction
enum ImGuiSortDirection_ { ImGuiSortDirection_None       = 0,
                           ImGuiSortDirection_Ascending  = 1,    // Ascending = 0->9, A->Z etc.
                           ImGuiSortDirection_Descending = 2     // Descending = 9->0, Z->A etc.
};

// User fill ImGuiIO.KeyMap[] array with indices into the ImGuiIO.KeysDown[512] array
enum ImGuiKey_ { ImGuiKey_Tab,
                 ImGuiKey_LeftArrow,
                 ImGuiKey_RightArrow,
                 ImGuiKey_UpArrow,
                 ImGuiKey_DownArrow,
...
enum ImGuiKeyModFlags_ { ImGuiKeyModFlags_None  = 0,
...
enum ImGuiBackendFlags_ { ImGuiBackendFlags_None                 = 0,
...
enum ImGuiColorEditFlags_ { ImGuiColorEditFlags_None           = 0,
...
enum ImGuiMouseCursor_ { ImGuiMouseCursor_None  = -1,
...
enum ImGuiCond_ { ImGuiCond_None         = 0,         // No condition (always set the variable), same as _Always
...
enum ImDrawListFlags_ { ImDrawListFlags_None                   = 0,
...
enum ImDrawCornerFlags_ { ImDrawCornerFlags_None     = ImDrawFlags_RoundCornersNone,           // Was == 0 prior to 1.82, this is now == ImDrawFlags_RoundCornersNone which is != 0 and not implicit
