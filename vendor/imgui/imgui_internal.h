...
enum ImGuiItemFlags_ { ImGuiItemFlags_None                     = 0,
...
enum ImGuiItemAddFlags_ { ImGuiItemAddFlags_None      = 0,
...
enum ImGuiItemStatusFlags_ { ImGuiItemStatusFlags_None             = 0,
...
enum ImGuiButtonFlagsPrivate_ { ImGuiButtonFlags_PressedOnClick                = 1 << 4,     // return true on click (mouse down event)
...
enum ImGuiComboFlagsPrivate_ { ImGuiComboFlags_CustomPreview = 1 << 20    // enable BeginComboPreview()
};

// Extend ImGuiSliderFlags_
enum ImGuiSliderFlagsPrivate_ { ImGuiSliderFlags_Vertical = 1 << 20,    // Should this slider be orientated vertically?
...
enum ImGuiSeparatorFlags_ { ImGuiSeparatorFlags_None           = 0,
                            ImGuiSeparatorFlags_Horizontal     = 1 << 0,    // Axis default to current layout type, so generally Horizontal unless e.g. in a menu bar
                            ImGuiSeparatorFlags_Vertical       = 1 << 1,
                            ImGuiSeparatorFlags_SpanAllColumns = 1 << 2
};

enum ImGuiTextFlags_ { ImGuiTextFlags_None                       = 0,
                       ImGuiTextFlags_NoWidthForLargeClippedText = 1 << 0
};

enum ImGuiTooltipFlags_ { ImGuiTooltipFlags_None                    = 0,
                          ImGuiTooltipFlags_OverridePreviousTooltip = 1 << 0    // Override will clear/ignore previously submitted tooltip (defaults to append)
};

// FIXME: this is in development, not exposed/functional as a generic feature yet.
// Horizontal/Vertical enums are fixed to 0/1 so they may be used to index ImVec2
enum ImGuiLayoutType_ { ImGuiLayoutType_Horizontal = 0,
                        ImGuiLayoutType_Vertical   = 1
};

enum ImGuiLogType { ImGuiLogType_None = 0,
                    ImGuiLogType_TTY,
                    ImGuiLogType_File,
                    ImGuiLogType_Buffer,
...
enum ImGuiInputSource { ImGuiInputSource_None = 0,
...
enum ImGuiInputReadMode { ImGuiInputReadMode_Down,
...
enum ImGuiNavHighlightFlags_ { ImGuiNavHighlightFlags_None        = 0,
...
enum ImGuiNavDirSourceFlags_ { ImGuiNavDirSourceFlags_None      = 0,
                               ImGuiNavDirSourceFlags_Keyboard  = 1 << 0,
                               ImGuiNavDirSourceFlags_PadDPad   = 1 << 1,
                               ImGuiNavDirSourceFlags_PadLStick = 1 << 2
};

enum ImGuiNavMoveFlags_ { ImGuiNavMoveFlags_None                = 0,
...
enum ImGuiNavLayer { ImGuiNavLayer_Main = 0,    // Main scrolling layer
...
enum ImGuiDataTypePrivate_ { ImGuiDataType_String = ImGuiDataType_COUNT + 1,
...
enum ImGuiNextWindowDataFlags_ { ImGuiNextWindowDataFlags_None              = 0,
...
enum ImGuiNextItemDataFlags_ { ImGuiNextItemDataFlags_None     = 0,
...
enum ImGuiOldColumnFlags_ { ImGuiOldColumnFlags_None                   = 0,
...
enum ImGuiTabBarFlagsPrivate_ { ImGuiTabBarFlags_DockNode     = 1 << 20,    // Part of a dock node [we don't use this in the master branch but it facilitate branch syncing to keep this around]
                                ImGuiTabBarFlags_IsFocused    = 1 << 21,
                                ImGuiTabBarFlags_SaveSettings = 1 << 22    // FIXME: Settings are handled by the docking system, this only request the tab bar to mark settings dirty when reordering tabs
};

// Extend ImGuiTabItemFlags_
enum ImGuiTabItemFlagsPrivate_ { ImGuiTabItemFlags_SectionMask_  = ImGuiTabItemFlags_Leading | ImGuiTabItemFlags_Trailing,
...
#    define IMGUI_TEST_ENGINE_ID_INFO( _ID, _TYPE, _DATA ) \
      if( g.TestEngineHookIdInfo == _ID ) ImGuiTestEngineHook_IdInfo( &g, _TYPE, _ID, (const void *) ( _DATA ) );
#    define IMGUI_TEST_ENGINE_ID_INFO2( _ID, _TYPE, _DATA, _DATA2 ) \
      if( g.TestEngineHookIdInfo == _ID ) ImGuiTestEngineHook_IdInfo( &g, _TYPE, _ID, (const void *) ( _DATA ), (const void *) ( _DATA2 ) );
#  else
